	...
	<body>
				...
				<div class="row fullscreen d-flex align-items-center justify-content-center">
					<div class="banner-content col-lg-6 col-md-6">
						<h1>
							Menjadi Mudah <br>
							Saat Bekerja  <br>
							Menggunakan Robotics
						</h1>
						<p class="text-white text-uppercase">
							Semua orang menginginkan inovasi melalui robotika
						</p>
						<a href="/about.php" class="primary-btn header-btn text-uppercase">View Details</a>
					</div>
				...
				<div class="row">
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
							<div class="thumb">
								<img src="/assets/robotics/img/p1.png" alt="">
							</div>
							<div class="details">
								<h4>The Upper Eye</h4>
								<p>
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
							<div class="thumb">
								<img src="/assets/robotics/img/p2.png" alt="">
							</div>
							<div class="details">
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
							<div class="thumb">
								<img src="/assets/robotics/img/p3.png" alt="">
							</div>
							<div class="details">
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
							<div class="thumb">
								<img src="/assets/robotics/img/p4.png" alt="">
							</div>
							<div class="details">
			...
			<div class="container-fluid">
				<div class="row align-items-center">
					<div class="col-lg-6 home-about-left no-padding">
						<img class="mx-auto d-block img-fluid" src="/assets/robotics/img/about-img.png" alt="">
					</div>
			...
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-lg-6 about-video-right justify-content-center align-items-center d-flex relative">
						...
						<a class="play-btn" href="https://www.youtube.com/watch?v=ARA0AxrnHdM"><img class="img-fluid mx-auto" src="/assets/robotics/img/play-btn.png" alt=""></a>
					</div>
				</div>
			</div>
		</section>
			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col single-brand">
						<img class="img-fluid" src="/assets/robotics/img/l1.png" alt="">
					</div>
					<div class="col single-brand">
						<img class="img-fluid" src="/assets/robotics/img/l2.png" alt="">
					</div>
					<div class="col single-brand">
						<img class="img-fluid" src="/assets/robotics/img/l3.png" alt="">
					</div>
					<div class="col single-brand">
						<img class="img-fluid" src="/assets/robotics/img/l4.png" alt="">
					</div>
					<div class="col single-brand">
						<img class="img-fluid" src="/assets/robotics/img/l5.png" alt="">
					</div>
				</div>
			</div>
		</section>
		...
		<section class="blog-area section-gap">
			<div class="container">
				<div class="row d-flex justify-content-center">
					<div class="col-md-12 pb-40 header-text text-center">
						<h1 class="pb-10">Artikel Terbaru</h1>
						<p>
							Who are in extremely love with eco friendly system.
						</p>
					</div>
				...
				<div class="row">
					...
					$blog = new Frontend();
					foreach ($blog->index() as $data) {
						?>
						<div class="col-lg-6 col-md-6 blog-right">
							<div class="thumb">
								<img class="img-fluid" src="/admin/artikel/img/<?php echo $data['foto'] ?>" alt="" style="width:500px; height:300px;">
							</div>
							<div class="detais">
								<ul class="tags">
								...
								<p class="date"><?php echo date('d F Y', strtotime($data['tgl'])) ?></p>
							</div>
						</div>
					<?php } ?>
				</div>
